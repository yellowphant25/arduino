...
const uint8_t RAMEN_ENC_INT[4]    = {2, 3, 18, 19};
const uint8_t RAMEN_UP_CURR_AIN[4]  = {A0, A2, A4, A6};
const uint8_t RAMEN_EJ_CURR_AIN[4]  = {A1, A3, A5, A7};
